...
public class ArticlesVO {
	...
	public String toString() {
		return "ArticlesVO [articlesno=" + articlesno + ", managerno=" + managerno + ", topicno=" + topicno + ", title="
				+ title + ", article=" + article + ", recom=" + recom + ", cnt=" + cnt + ", replycnt=" + replycnt
				+ ", pw=" + pw + ", word=" + word + ", gdate=" + gdate + ", map=" + map + ", youtube=" + youtube
				+ ", file1MF=" + file1MF + ", size1_label=" + size1_label + ", file1=" + file1 + ", file1saved="
				+ file1saved + ", thumb1=" + thumb1 + ", size1=" + size1 + ", price=" + price + ", dc=" + dc
				+ ", saleprice=" + saleprice + ", point=" + point + ", salecnt=" + salecnt + ", start_num=" + start_num
