...
public class GermanVO {
    /*
     * germanno INT NOT NULL AUTO_INCREMENT, -- 회원 번호, 레코드를 구분하는 컬럼 id VARCHAR(20)
    ...
    public int getGermanno() {
        return germanno;
    }
    public void setGermanno(int germanno) {
        this.germanno = germanno;
    }
    public String getId() {
        return id;
    }
