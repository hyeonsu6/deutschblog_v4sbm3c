...
<title>DeutschBlog Calendar Message</title>
			...
			<UL>
				<c:choose>
					...
					<c:when test="${code == 'create_success'}">
						<%-- Java if --%>
						<li class='li_none'>
							<span class="span_success">새로운 일정을 등록했습니다.</span>
						</li>
					</c:when>
					...
					<c:when test="${code == 'create_fail'}">
						<%-- Java if --%>
						<li class='li_none'>
							<span class="span_fail">새로운 일정 등록에 실패했습니다.</span>
						</li>
					</c:when>
					...
					<c:when test="${code == 'delete_success'}">
						<%-- Java if --%>
						<li class='li_none'>
							<span class="span_success">일정 삭제에 성공했습니다.</span>
						</li>
					</c:when>
