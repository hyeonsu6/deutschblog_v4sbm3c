...
<body>
	...
	<div class="container mt-3">
		<ul class="list-group list-group-flush">
			<li class="list-group-item">번호: <%=topicVO.getTopicno()%></li>
			<li class="list-group-item">이름: <%=topicVO.getName()%></li>
			<li class="list-group-item">등록글 수: <%=topicVO.getCnt()%></li>
			<li class="list-group-item">등록일: <%=topicVO.getGdate()%></li>
		</ul>
	</div>
	<td class="td_bs">
