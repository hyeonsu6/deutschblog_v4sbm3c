...
<body>
	...
	<DIV class='title_line'>${topicVO.name }> ${title } > 삭제</DIV>
		...
		<form name='frm' id='frm' method='get' action='./list_by_topicno_search_paging.do'>
			...
			<c:if test="${param.word.length() > 0 }">
				<button type='button' class='btn btn-dark btn-sm'
					onclick="location.href='./list_by_topicno.do?topicno=${topicVO.topicno}&word='"
              ...
              상품 관련 이미지가 없습니다.
				...
				<DIV style='text-align: left; width: 47%; float: left;'>
					...
					<FORM name='frm' method='post' action='./delete.do'>
						<input type='hidden' name='articlesno' value='${articlesno}'> <input type='hidden' name='topicno'
							value='${topicno}'> <input type='hidden' name='now_page' value='${param.now_page}'> <br> <br>
