			...
			<ul>
				<c:choose>
					<c:when test="${param.code == 'create_success'}">
						...
						<li class='li_none'>
							<button type='button' onclick="location.href='./login.do?id=${param.id}'" class="btn btn-outline-warning btn-sm">로그인</button>
						</li>
					</c:when>
					...
					<c:when test="${param.code == 'update_success'}">
						...
						<li class='li_none'>
							<button type='button' onclick="location.href='/'" class="btn btn-outline-warning btn-sm"
								style="background-color: #583E26;">시작 화면</button>
							<button type='button' onclick="location.href='/german/list.do'" class="btn btn-outline-warning btn-sm">회원
								목록</button>
						</li>
					</c:when>
					...
					<c:when test="${param.code == 'passwd_update_success'}">
						...
						<li class='li_none'>
							<button type='button' onclick="location.href='/'" class="btn btn-outline-warning btn-sm">확인</button>
						</li>
					</c:when>
